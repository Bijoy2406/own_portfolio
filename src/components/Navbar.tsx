  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        {/* Desktop Links */}
        <nav className="hidden md:flex items-center gap-1 bg-zinc-900/50 p-1.5 rounded-full border border-zinc-800/60 backdrop-blur-sm">
          {NAV_LINKS.map((link) => {
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg border border-zinc-800 bg-zinc-900/80 text-zinc-300 hover:text-white hover:border-zinc-700 transition-colors"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden border-b border-zinc-800 bg-zinc-950/95 backdrop-blur-xl px-6 py-4"
          >
